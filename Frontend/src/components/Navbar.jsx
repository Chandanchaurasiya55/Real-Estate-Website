        ...
        {isAdminPanel ? (
          ...
          <div className="hidden items-center justify-end gap-2 text-sm font-medium text-slate-200 lg:flex">
            ...
            <div className="ml-1 flex items-center gap-1.5">
              <Link to="/properties" className="rounded-lg bg-cyan-500 px-3 py-2 text-xs font-semibold text-white shadow-lg hover:bg-cyan-600">🔍 Search</Link>
              {user ? (
                <Link
                ...
                <Link to="/login" className="rounded-lg bg-cyan-500 px-3 py-2 text-xs font-semibold text-white hover:bg-cyan-600">Login</Link>
              )}
            </div>
          </div>
        )}
